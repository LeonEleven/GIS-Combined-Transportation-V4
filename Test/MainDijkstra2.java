...
public class MainDijkstra2 {
  ...
  public static void main(String[] args) {
    ...
    // nodeList.add(new Node(27.0, 2429.668269, -4308.878914, 2.0, 15000.0));
    // nodeList.add(new Node(12.0, 16741.985547, -7324.639202, 1.0, 7500.0));
    // nodeList.add(new Node(13.0, 23769.748577, -1939.810504, 1.0, 7500.0));
    // nodeList.add(new Node(13.0, 28236.953325, -7683.38491, 0.0, 4500.0));
